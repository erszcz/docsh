...
-define(TESTED, docsh_docsh_docs_v1).

all() ->
    [internal_to_docsh_docs_v1].

internal_to_docsh_docs_v1(_) ->
    Docs = ?TESTED:from_internal(internal()),
    ?assertEqual(docsh_docs_v1, element(1, Docs)),
